...
class Mf2ffOptions:
    ...
    def _print_help_and_exit(self):
        ...
        help_text = (
            ...
            '  -input-encoding=STR\n'
            '                    specify encoding name or encoding file of the input file.\n'
            ...
            '  -output-encoding=STR\n'
            '                    set encoding name or encoding file of the generated output.\n'
            ...
            'into a single font, e.g -input-file:0=font0.mf\n'
            '-input-encoding:0=TeX-math-italic -input-file:1=font1.mf\n'
            '-input-encoding:1=TeX-math-symbols [...]\n'
            '\n'
